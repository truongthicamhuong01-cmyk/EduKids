const TASK_TEMPLATES = [
  {
    ...
    type: "exercise",
    icon: "📘",
    title: (checkpointTitle) => `Hoan thanh bai tap ${checkpointTitle}`,
    description: (checkpointTitle) => `Lam xong it nhat 1 bai tap o ${checkpointTitle}`,
  ...
  },
  {
    ...
    type: "quiz",
    icon: "⭐",
    title: (checkpointTitle) => `Lam Quiz AI ${checkpointTitle}`,
    description: (checkpointTitle) => `Kiem tra kien thuc bang Quiz AI tai ${checkpointTitle}`,
  ...
  },
  {
    ...
    description: (checkpointTitle) => `Nhan goi y tu AI Coach cho ${checkpointTitle}`,
